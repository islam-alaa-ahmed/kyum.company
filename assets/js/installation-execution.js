...
function currentRequestCandidates(){return rows.filter(isActive).sort((a,b)=>new Date(b.selectedForExecutionAt||b.startedAt||b.onRouteAt||0)-new Date(a.selectedForExecutionAt||a.startedAt||a.onRouteAt||0))}
