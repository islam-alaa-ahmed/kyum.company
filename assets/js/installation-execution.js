...
function mapButton(r){const href=r.customerMapUrl||(r.installationAddress?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(r.installationAddress)}`:'');return href?`<a class="execution-map-btn" data-execution-map="${esc(r.id)}" href="${esc(href)}" target="_blank" rel="noopener">فتح في خرائط جوجل</a>`:'<span class="installation-card-muted">لا يوجد رابط موقع مسجل</span>'}
