(function () {
  ...
  function loadFreshService() {
    return new Promise((resolve, reject) => {
      ...
      script.src = 'assets/js/installations-service.js?v=18.50.4-recovery';
      script.async = false;
